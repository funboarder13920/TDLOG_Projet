...
>>>>>>> e0b51a387a3a81a1a4318883233ad55fd8c53260
...
=======
        # TODO : rajouter rÃ´le du joueur qu'on doit placer
        if (nEquipe == 1):
            while k < 6 :
                print("\n")
...
=======
            ...
            if self.jeu.matrice[pos[0]][pos[1]][0].ko and not self.jeu.matrice[self.pos[0]][self.pos[1]][0].ko:  #Cas oÃ¹ on va sur une case oÃ¹ il y a un joueur ko
                self.jeu.matrice[pos[0]][pos[1]].append(self)
                self.jeu.matrice[self.pos[0]][self.pos[1]].remove(self)
                if self.jeu.matrice[self.pos[0]][self.pos[1]] == []:
            ...
            elif self.jeu.matrice[self.pos[0]][self.pos[1]][0].ko and not self.jeu.matrice[pos[0]][pos[1]][0].ko: #Cas oÃ¹ on part d'une case oÃ¹ il y a un joueur ko
                self.jeu.matrice[pos[0]][pos[1]][0] = self
                self.jeu.matrice[self.pos[0]][self.pos[1]].remove(self)
            elif self.jeu.matrice[self.pos[0]][self.pos[1]][0].ko and self.jeu.matrice[pos[0]][pos[1]][0].ko: #Cas oÃ¹ on part d'une case oÃ¹ un joueur est ko pour arriver a une case oÃ¹ un autre joueur est ko
                self.jeu.matrice[pos[0]][pos[1]].append(self)
                self.jeu.matrice[self.pos[0]][self.pos[1]].remove(self)
            else: #Cas oÃ¹ les joueurs ko ne sont pas impliques
                self.jeu.matrice[pos[0]][pos[1]][0] = self
                self.jeu.matrice[self.pos[0]][self.pos[1]].append(joueur(None,self,3,self.pos,"",0))
                self.jeu.matrice[self.pos[0]][self.pos[1]].remove(self)             
...
=======
            ...
            'Voulez-vous intercepter le lancer du joueur adverse {0} de coordonnÃ©es ({1},{2}) au joueur adverse {3} de coordonnees ({4},{5})'.format(prop[joueur1.numero],joueur1.pos[1],joueur1.pos[0],prop[joueur2.numero],joueur2.pos[1],joueur2.pos[0]))
            print("\n , avec votre joueur {0} de coordonnÃ©es ({1},{2})".format(prop[self.numero],self.pos[1],self.pos[0])
            print("\n")	 
>>>>>>> e0b51a387a3a81a1a4318883233ad55fd8c53260
...
<<<<<<< HEAD
                                                        ...
                                                        if joueur2.pos[0] > 1:
                                                                ...
                                                                log.debug("Cas particulier où le joueur plaqué est sur le bord gauche")
=======
                                                        log.debug("Joueur plaque a droite du plaqueur")
                                                        if joueur2.pos[0] > 1:
                                                                self.jeu.ballon.position += (-1,0)
                                                        else: 
                                                                log.debug("Cas particulier oÃ¹ le joueur plaque est sur le bord gauche")
>>>>>>> e0b51a387a3a81a1a4318883233ad55fd8c53260
                                                                if joueur2.pos[1] < nbLigne/2:
                                                                        self.jeu.ballon.position += (0,1)
                                                                else:
...
<<<<<<< HEAD
                                                                log.debug("Joueur plaqué au dessus du plaqueur")
                                                                if joueur2.pos[1] > 0:
                                                                        self.jeu.ballon.position += (0,-1)
                                                                else:
                                                                        log.debug("Le joueur plaqué est tout en haut")
=======
...
<<<<<<< HEAD
                                                                log.debug("Joueur plaqué en dessous du plaqueur")
                                                                if joueur2.pos[1] < nbLigne-1:
                                                                        self.jeu.ballon.position += (0,1)
                                                                else: 
                                                                        log.debug("Le joueur plaqué est tout en bas")
=======
...
>>>>>>> e0b51a387a3a81a1a4318883233ad55fd8c53260
                                                                        if joueur2.pos[0] < nbColonne/2:
                                                                                ...
                                                                                self.jeu.ballon.position += (-1,0)
<<<<<<< HEAD
                                                log.debug("Un joueur sur la case du ballon qui le récupère")
=======
...
=======
        ...
        def reglePlaquage():
            if (self.tutoriel==1):
                ...
                '\n Vous devez etre a cÃ´te d\'un joueur pour le plaquer'
                '\n Toutefois, vous pouvez utiliser vos deplacements dans l\'ordre que vous voulez'
